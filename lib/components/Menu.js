        ...
        <div id="sidebar-wrapper">
            <ul className="sidebar-nav">
              ...
              <li className="dropdown">
                <Link activeClassName="active" to="/progress" className="dropdown-toggle" onClick={this.showSubMenu.bind(this)} data-toggle="dropdown">Успішність <span className="caret"></span></Link>
                <ul className="dropdown-menu" id="submenu" role="menu">
                  <li><Link to="/progress">KN-306b</Link></li>
